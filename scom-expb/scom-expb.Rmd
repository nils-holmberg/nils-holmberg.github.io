...
### 6.1.1 Planering av forskningsfrågor {#sub06.1.1}
...
### 6.1.2 Rapportering av forskningsfrågor {#sub06.1.2}
...
## 6.2 Operationalisering {#sec06.2}
[06-2-wc-file]: <> (135.59 %)
...
### 6.2.1 Planering av operationalisering {#sub06.2.1}
...
### 6.2.2 Rapportering av operationalisering {#sub06.2.2}
...
```{r img-model, echo=F, fig.cap="någon modell", out.width='80%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("../fig/model.png")
```

### 6.3.1 Planering av hypoteser {#sub06.3.1}
...
### 6.3.2 Rapportering av hypoteser {#sub06.3.2}
...
## 7.1 Pilottest  {#sec07.1}
[07-1-wc-file]: <> (30.21 %)
[07-1-comment]: <> (5 sidor)

Innan man genomför ett skarpt experiment, vilket ofta kräver mycket resurser i form av tid och arbete, är det klokt att genomföra experimentet i liten skala. På så vis kan forskarna i ett tidigt stadium fånga upp problem med experimentdesignen. Detta kallas för att vi genomför en förstudie eller ett pilottest. Det är ofta användbart att förstå utvecklingen av en experimentell studie som en iterativ process, där genomförandet successivt kan förbättras baserat på erfarnheter från tidigare genomföranden. Slutligen är det ofta en fördel att kunna rapportera ett pilottest eller en förstudie i samband med att sakkunniga forskare granskar och bedömer om det är lämpligt att publicera resultaten i en tidskrift.
...
En annan sorts _mätinstrument_ utgörs av olika typer av sensorisk apparatur som kan användas för att samla in någon form av fysiologiska responser, exempelvis en ögonrörelsemätare (på engelska eye-tracker) som används för att uppmäta var på datorskärmen deltagarna riktar sin visuella uppmärksamhet. Pilottest används här för att försäkra oss om att vårt handhavande av mätutrustningen är korrekt (t.ex. kalibrering, applicering av elektroder på deltagaren), samt att datainsamligen genererar mätdata med tillfredställande nogrannhet (engelska accuracy, jfr. precision).

- Mätinstrument
Testa validitet och reliabilitet. 
ta hjälp av tidigare forskning, validerade survey-frågor etc

- Experimentella villkor
stimulus program, triggers etc.

- Experimentell design

- Procedur
Intervjua deltagare efter. standardisering, reliabilitet
...
### 7.2.1 Representativt urval {#sub07.2.1}
...
### 7.2.2 Demografiska egenskaper {#sub07.2.2}
...
### 7.2.3 Etiska hänsynstaganden {#sub07.2.3}
...
### 7.2.4 Planering av deltagare {#sub07.2.4}
...
### 7.2.5 Rapportering av deltagare {#sub07.2.5}
...
### 7.3.1 Mätning av subjektiva responser {#sub07.3.1}
...
### 7.3.2 Mätning av objektiva responser {#sub07.3.2}
...
### 7.3.3 Beroende variabler {#sub07.3.3}
...
### 7.3.4 Planering av mätinstrument {#sub07.3.4}
...
### 7.3.5 Rapportering av mätinstrument {#sub07.3.5}
...
## 7.4 Experimentella villkor {#sec07.4}
[07-4-wc-file]: <> (57.42 %)
...
### 7.4.1 Kontrollvillkor och behandlingsvillkor {#sub07.4.1}
...
### 7.4.2 Oberoende variabler {#sub07.4.2}
...
### 7.4.3 Kontrollvariabler {#sub07.4.3}

En annan faktor som har stor betydelse i samband med urvalet av

### 7.4.4 Utrustning och materiel {#sub07.4.4}
...
### 7.4.5 Planering av experimentella villkor {#sub07.4.5}
...
### 7.4.6 Rapportering av experimentella villkor {#sub07.4.6}

Rapportering - exempel på hur detta skulle kunna formuleras i ett manuskript

## 7.5 Experimentell design {#sec07.5}
[07-5-wc-file]: <> (110.92 %)
...
### 7.5.1 Instruktioner och uppgifter {#sub07.5.1}
...
### 7.5.2 Randomisering och balansering {#sub07.5.2}
...
### 7.5.3 Mellangruppsdesign {#sub07.5.3}
...
### 7.5.4 Inomgruppsdesign {#sub07.5.4}
...
### 7.5.5 Upprepade villkor {#sub07.5.5}
...
### 7.5.6 Faktoriell design {#sub07.5.6}
...
### 7.5.7 Kvasi-experimentell design {#sub07.5.7}
...
### 7.5.8 Planering av experimentell design {#sub07.5.8}
...
### 8.1.1 Deskriptiv statistik {#sub08.1.1}
...
### 8.1.2 Inferentiell statistik {#sub08.1.2}
...
### 8.1.3 Presentation av statistik {#sub08.1.3}
